        ...
        <section id="dashboard" className="landing-shell mt-4 scroll-mt-28 rounded-[30px] px-4 py-5 sm:mt-6 sm:rounded-[42px] sm:px-5 sm:py-6 md:px-7 md:py-8 xl:px-9 xl:py-9">
          <div className="grid gap-8 xl:grid-cols-[minmax(0,0.88fr)_minmax(0,1.02fr)] xl:items-center">
            <div className="space-y-6">
              <div className="flex w-full items-start gap-2 rounded-full border border-primary/12 bg-primary/6 px-3.5 py-2 text-left text-sm font-semibold leading-6 text-primary shadow-soft sm:inline-flex sm:w-auto sm:items-center sm:px-4">
                <span className="mt-1.5 inline-flex h-2.5 w-2.5 shrink-0 rounded-full bg-secondary animate-beat sm:mt-0" />
                {t(lt('All-in-one healthcare management platform', 'All-in-One-Plattform für Gesundheitsmanagement'))}
              </div>

              <div className="max-w-2xl">
                <h1 className="landing-display text-[2.65rem] leading-[0.96] text-foreground sm:text-[3.6rem] lg:text-[4.8rem] 2xl:text-[6rem]">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link
                  to="/login"
                  className="inline-flex h-12 w-full items-center justify-center rounded-full bg-[linear-gradient(135deg,hsl(var(--primary)),hsl(var(--secondary)))] px-5 text-sm font-semibold text-white shadow-soft transition hover:translate-y-[-1px] hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/45 focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:h-14 sm:w-auto sm:px-7"
                >
                  {t(lt('Start with login', 'Mit dem Login starten'))}
                </Link>
                <a
                  href="#features"
                  className="inline-flex h-12 w-full items-center justify-center rounded-full border border-primary/20 bg-card/80 px-5 text-sm font-semibold text-primary shadow-soft transition hover:border-primary/35 hover:bg-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/45 focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:h-14 sm:w-auto sm:px-7"
                >
            ...
            <div className="relative xl:pl-2">
              <div className="landing-stage animate-fade-up rounded-[28px] p-2.5 sm:p-4 md:p-5 [animation-delay:120ms] xl:ml-auto xl:max-w-[820px]">
                <div className="grid overflow-hidden rounded-[26px] border border-border/70 bg-white shadow-[0_34px_80px_hsl(var(--primary)/0.12)] sm:rounded-[34px] lg:grid-cols-[164px_minmax(0,1fr)]">
                  <aside className="hidden flex-col gap-4 bg-[linear-gradient(180deg,hsl(212_84%_27%),hsl(217_73%_18%))] px-3 py-4 text-white lg:flex">
                  ...
                  <div className="min-w-0 space-y-4 p-3.5 sm:p-4 md:p-5">
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                      <div>
                        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-primary">
                          {t(lt('Overview', 'Überblick'))}
                        </p>
                        <h2 className="landing-display mt-1 text-2xl text-foreground sm:text-3xl">
                      ...
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="flex min-w-0 items-center gap-3 rounded-full border border-border/60 bg-background/80 px-2 py-2 shadow-soft">
                          ...
                          <div className="hidden min-w-0 pr-2 min-[420px]:block">
                            <p className="truncate text-sm font-semibold text-foreground">Dr. Sarah Johnson</p>
                    ...
                    <div className="grid gap-3 md:grid-cols-2 2xl:grid-cols-4">
                      {overviewStats.map((item, index) => (
                        ...
                        >
                          ...
                          <p className="landing-display mt-3 break-words text-[2rem] leading-none text-foreground sm:text-[2.5rem] 2xl:text-[3rem]">
                            {item.value}
                          </p>
                      ...
                      <article className="rounded-[28px] border border-border/60 bg-white p-4 shadow-soft">
                        ...
                        <div className="mt-4 space-y-3">
                          {appointmentRows.map((item) => (
                            <div key={`${item.name}-${item.time}`} className="flex flex-wrap items-center gap-3 rounded-[20px] border border-border/50 bg-background/55 px-3 py-3 min-[430px]:flex-nowrap">
                              ...
                              <div className="ml-[3.25rem] basis-full text-left min-[430px]:ml-auto min-[430px]:basis-auto min-[430px]:text-right">
                      ...
                      <div className="grid content-start gap-3">
                        <article className="rounded-[28px] border border-border/60 bg-white p-4 shadow-soft">
                          <div className="flex flex-col gap-2 min-[460px]:flex-row min-[460px]:items-center min-[460px]:justify-between">
                            ...
                            <span className="text-xs font-semibold uppercase tracking-[0.12em] text-primary sm:tracking-[0.18em]">
                              {t(lt('This month', 'Diesen Monat'))}
                            </span>
                          </div>

                          <div className="mt-4 rounded-[24px] border border-border/50 bg-background/60 p-3">
                            <svg viewBox="0 0 360 180" className="h-36 w-full sm:h-44">
        ...
        <section id="solutions" className="mt-8 grid items-start scroll-mt-28 gap-6 xl:grid-cols-[0.72fr_1.28fr]">
          <div className="grid self-start content-start gap-4">
            <article className="landing-shell rounded-[36px] p-6 md:p-8">
              ...
              <h2 className="landing-display mt-3 text-[2.2rem] leading-[0.98] text-foreground sm:text-[3rem] xl:text-[4rem]">
        ...
        >
          <div className="grid gap-5 xl:grid-cols-[1.1fr_auto] xl:items-center">
            <div>
              ...
              <h2 className="landing-display mt-3 text-[2rem] leading-[1] sm:text-[2.8rem] xl:text-[3.4rem]">
