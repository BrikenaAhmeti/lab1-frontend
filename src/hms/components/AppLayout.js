...
export default function AppLayout() {
    ...
    return (_jsxs("div", { className: "workspace-page relative min-h-screen overflow-hidden", children: [_jsx("div", { className: "workspace-grid pointer-events-none absolute inset-0 opacity-70" }), _jsx("div", { className: "landing-orb left-[-12rem] top-[-8rem] h-[24rem] w-[24rem]" }), _jsx("div", { className: "landing-orb bottom-[-14rem] right-[-8rem] h-[26rem] w-[26rem]" }), _jsxs("div", { className: "relative mx-auto flex min-h-screen max-w-[1600px] gap-3 md:gap-4", children: [_jsx("button", { type: "button", "aria-label": menuLabel, className: clsx('fixed inset-0 z-40 bg-slate-950/35 backdrop-blur-sm transition md:hidden', isSidebarOpen ? 'opacity-100' : 'pointer-events-none opacity-0'), onClick: closeSidebar }), _jsx("aside", { className: clsx('workspace-shell workspace-sidebar fixed inset-y-0 left-0 z-50 flex w-[280px] max-w-[calc(100vw-1.5rem)] flex-col rounded-r-[24px] border border-l-0 border-white/10 text-white shadow-[0_34px_80px_hsl(214_78%_18%/0.34)] transition-transform duration-300 md:sticky md:top-0 md:h-screen md:translate-x-0 md:self-start', isSidebarOpen ? 'translate-x-0' : '-translate-x-[112%]'), children: _jsxs("div", { className: "flex h-full flex-col p-3", children: [_jsxs("div", { className: "flex items-start justify-between gap-3", children: [_jsxs(NavLink, { to: "/dashboard", end: true, className: "flex min-w-0 items-center gap-2 rounded-2xl outline-none transition hover:opacity-90 focus-visible:ring-2 focus-visible:ring-ring/45", onClick: closeSidebar, children: [_jsx("img", { src: "/medsphere.png", alt: "MedSphere logo", className: "h-10 w-auto object-contain" }), _jsxs("div", { className: "min-w-0", children: [_jsx("p", { className: "truncate text-[11px] font-semibold uppercase tracking-[0.28em] text-white/72", children: "MedSphere" }), _jsx("p", { className: "truncate text-sm text-sky-50/78", children: t(commonCopy.appSubtitle) })] })] }), _jsx("button", { type: "button", "aria-label": t(lt('Close menu', 'Mbyll menune')), className: "inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-white/12 bg-white/10 text-white transition hover:bg-white/16 md:hidden", onClick: closeSidebar, children: _jsx("svg", { viewBox: "0 0 24 24", className: "h-5 w-5 fill-none stroke-current stroke-[1.8]", children: _jsx("path", { d: "m6 6 12 12M18 6 6 18" }) }) })] }), _jsx("nav", { className: "mt-4 min-h-0 flex-1 overflow-y-auto pr-1", children: _jsx("div", { className: "space-y-1.5", children: navigationItems.map((item) => (_jsx(NavLink, { to: item.to, end: item.to === '/dashboard', className: ({ isActive }) => clsx('group flex items-start gap-2.5 rounded-[18px] border px-3 py-2.5 transition duration-200', isActive
