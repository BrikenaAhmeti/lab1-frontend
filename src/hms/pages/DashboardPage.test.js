...
function renderPage() {
    ...
    render(_jsx(LanguageProvider, { children: _jsx(QueryClientProvider, { client: queryClient, children: _jsx(DashboardPage, {}) }) }));
}
describe('DashboardPage', () => {
    ...
    it('shows a retry action with a friendly message when a dashboard list fails', async () => {
        mockFetchArrayWithFallback.mockImplementation((paths) => {
