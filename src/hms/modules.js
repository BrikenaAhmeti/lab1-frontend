...
export const referenceConfigs = {
    ...
    medicalRecords: {
        ...
        getLabel: (item) => `${getPatientName(item) || getValue(item, 'patient_id', 'patientId')} - ${getValue(item, 'record_date', 'recordDate')}`,
    },
    admissions: {
        key: 'admissions',
        endpoint: '/api/admissions',
        params: { page: 1, limit: 100, sortBy: 'admission_date', order: 'DESC' },
        getLabel: (item) => `${getPatientName(item) || getValue(item, 'patient_id', 'patientId')} - ${getValue(item, 'room.room_number', 'roomNumber', 'room_id')}`,
    },
};
export const moduleConfigs = {
    patients: {
        ...
        description: lt('Manage patient profiles with search, filtering, sorting, and pagination.', 'Menaxhoni profilet e pacientëve me kërkim, filtra, renditje dhe paginim.'),
        endpoint: '/api/patients',
    ...
    doctors: {
        ...
        description: lt('Manage doctors, their departments, and specializations.', 'Menaxhoni mjekët, departamentet dhe specializimet e tyre.'),
        endpoint: '/api/doctors',
    ...
    departments: {
        ...
        description: lt('Manage hospital departments and their locations.', 'Menaxhoni departamentet e spitalit dhe vendndodhjet e tyre.'),
    ...
    appointments: {
        ...
        description: lt('Manage appointment scheduling with date, patient, doctor, and status filters.', 'Menaxhoni terminet me filtra për datë, pacient, mjek dhe status.'),
        ...
        cleanPayload: (values) => stripEmptyValues(values),
        getItemTitle: (item) => `${getPatientName(item) || getValue(item, 'patient_id', 'patientId')} - ${getValue(item, 'date', 'appointmentDate')}`,
    },
    'medical-records': {
        key: 'medical-records',
        ...
        description: lt('Manage diagnosis, treatment, and prescription summaries.', 'Menaxhoni diagnozën, trajtimin dhe përmbledhjet e recetave.'),
        endpoint: '/api/medical-records',
    ...
    prescriptions: {
        ...
        description: lt('Manage prescription details linked to medical records.', 'Menaxhoni detajet e recetave të lidhura me kartelat mjekësore.'),
    ...
    rooms: {
        ...
        description: lt('Manage room capacity, type, department, and availability.', 'Menaxhoni kapacitetin, llojin, departamentin dhe disponueshmërinë e dhomave.'),
        endpoint: '/api/rooms',
    ...
    admissions: {
        ...
        description: lt('Manage active and completed patient admissions.', 'Menaxhoni pranimet aktive dhe të përfunduara të pacientëve.'),
        endpoint: '/api/admissions',
    ...
    invoices: {
        ...
        description: lt('Manage invoice amounts, payment status, and patient billing.', 'Menaxhoni vlerat e faturave, statusin e pagesës dhe faturimin e pacientëve.'),
    ...
    nurses: {
        ...
        description: lt('Manage nurses by department and shift.', 'Menaxhoni infermierët sipas departamentit dhe ndërrimit.'),
        endpoint: '/api/nurses',
