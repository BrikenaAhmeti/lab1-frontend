...
export const moduleKeyToAppModule = {
    patients: 'patients',
    doctors: 'doctors',
...
export function getPermissionSet(userRoles, module) {
...
export function hasPermission({ userRoles, module, action }) {
    return getPermissionSet(userRoles, module).has(action);
}
export function hasAnyPermission(userRoles, module, actions) {
    const permissionSet = getPermissionSet(userRoles, module);
    return actions.some((action) => permissionSet.has(action));
}
export function getModulePermissionFlags(userRoles, module) {
    const permissionSet = getPermissionSet(userRoles, module);
    return {
