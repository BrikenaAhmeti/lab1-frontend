...
export default function Input({ label, hint, error, className, id, ...rest }) {
    ...
    return (_jsxs("label", { className: "block space-y-1.5", htmlFor: fieldId, children: [label && _jsx("span", { className: "text-sm font-medium text-foreground", children: label }), _jsx("input", { id: fieldId, className: clsx('ds-field', error && 'border-danger focus-visible:ring-danger/35', className), ...rest }), error ? (_jsx("span", { className: "text-xs text-danger", children: error })) : hint ? (_jsx("span", { className: "text-xs text-muted-foreground", children: hint })) : null] }));
}
