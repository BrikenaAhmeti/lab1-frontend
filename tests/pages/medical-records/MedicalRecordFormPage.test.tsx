...
vi.mock('@/domain/medical-records/medical-records.hooks', () => ({
  useMedicalRecord: (id: string) => mockUseMedicalRecord(id),
  ...
  return render(
    <Provider store={store}>
      <MemoryRouter initialEntries={[route]}>
        <Routes>
          <Route path="/app/medical-records/new" element={<MedicalRecordFormPage />} />
          <Route path="/app/medical-records/:id/edit" element={<MedicalRecordFormPage />} />
          <Route path="/app/medical-records" element={<div>Medical records</div>} />
        </Routes>
      </MemoryRouter>
    </Provider>
  );
