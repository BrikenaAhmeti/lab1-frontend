...
vi.mock('@/domain/medical-records/medical-records.hooks', () => ({
    ...
    useMedicalRecordPrescriptions: (medicalRecordId) => mockUseMedicalRecordPrescriptions(medicalRecordId),
...
function renderPage(route, roles) {
    ...
    return render(_jsx(Provider, { store: store, children: _jsx(MemoryRouter, { initialEntries: [route], children: _jsx(PrescriptionsPage, {}) }) }));
}
