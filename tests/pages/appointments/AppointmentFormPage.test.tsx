...
describe('AppointmentFormPage', () => {
  ...
  it('submits a new appointment with trimmed values', async () => {
    render(
      <MemoryRouter initialEntries={['/app/appointments/new']}>
        <Routes>
          <Route path="/app/appointments/new" element={<AppointmentFormPage />} />
          <Route path="/app/appointments/:id" element={<div>Appointment details</div>} />
        </Routes>
      </MemoryRouter>
    );
