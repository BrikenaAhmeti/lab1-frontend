...
vi.mock('@/domain/rooms/rooms.hooks', () => ({
    useRooms: (params) => mockUseRooms(params),
...
function renderPage(route, roles) {
    ...
    return render(_jsx(Provider, { store: store, children: _jsx(MemoryRouter, { initialEntries: [route], children: _jsx(RoomsListPage, {}) }) }));
}
